  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              shrink="0"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconxnl")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Shareyvi")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharerxk")}
            ></Text>
            <MyIcon
              shrink="0"
              type="bookmark_border"
              {...getOverrideProps(overrides, "MyIconxcp")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="share"
              {...getOverrideProps(overrides, "MyIconpro")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIcondis")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read morewbv")}
      >
        <MyIcon
          shrink="0"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIconkpp")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moretha")}
        ></Text>
      </Flex>
    </Flex>
  );
