        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136vbe")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconanv")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectormgg")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.tao"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376wti")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconhhr")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectoridq")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.zyv"
                )}
              ></Text>
            </Flex>
          </Flex>
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136yzx")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconuve")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectortnc")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.gjm"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376coa")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconzaf")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorkfm")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.qiw"
                )}
              ></Text>
            </Flex>
          </Flex>
