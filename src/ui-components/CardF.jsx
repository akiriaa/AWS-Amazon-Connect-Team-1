      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgecuu")}
          ></Badge>
          <Badge
            fontSize="12px"
            lineHeight="12px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgelvb")}
          ></Badge>
          <Badge
            fontSize="12px"
            lineHeight="12px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgenpb")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featuregyc")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconlou")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectoryrz")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurelco")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconend")}
            >
              <Icon
                width="17.58984375px"
                height="13.4100341796875px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectormbv")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureebh")}
          >
            <View
              width="24px"
              height="24px"
            ...
            >
              <Icon
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectormnc")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
