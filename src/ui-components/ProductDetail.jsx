      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7pgl")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerglo")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7trr")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerupo")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7rez")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28yth")}
          >
            <Button
              borderRadius="4px"
              display="flex"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonfcc")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonkgn")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonork")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonvji")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28rxn")}
          >
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonqce")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonyza")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonaaw")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttontzv")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
