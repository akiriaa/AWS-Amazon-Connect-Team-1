...
export default function NavBar(props) {
  const { audio, overrides, ...rest } = props;
  const recordingsOnClick = useNavigateAction({
    type: "url",
    url: audio?.filePath,
  });
  const dashboardOnClick = useNavigateAction({ type: "reload" });
  ...
  return (
    ...
    >
      ...
      <Text
        ...
        whiteSpace="pre-wrap"
        children="TeamONE"
        {...getOverrideProps(overrides, "TeamONE")}
      ></Text>
      <Text
        fontFamily="Inter"
        fontSize="16px"
