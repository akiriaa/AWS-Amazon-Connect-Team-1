    ...
    >
      ...
      >
        <Flex
          ...
          {...getOverrideProps(overrides, "Frame 321odt")}
        >
          <View
            height="80px"
            shrink="0"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "ORGANIZATIONxlc")}
            ></Text>
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 321kpi")}
            >
              <View
                width="24px"
                height="24px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Icondus")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectorfrq")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                {...getOverrideProps(overrides, "Lorem Ipsumsbg")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              <View
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconfhh")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectorkjp")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                whiteSpace="pre-wrap"
                children="Lorem Ipsum"
                {...getOverrideProps(overrides, "Lorem Ipsumxur")}
              ></Text>
            </Flex>
          </Flex>
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 321qab")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="ORGANIZATION"
              {...getOverrideProps(overrides, "ORGANIZATIONdho")}
            ></Text>
            <Flex
              gap="16px"
              direction="column"
            ...
            >
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconomd")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorrwt")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumbwp")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconfyz")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectormbj")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumsmu")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconydu")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectoroze")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsummog")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconavz")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorijr")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumhrf")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconunh")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorafc")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumylc")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconglv")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorfpq")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumlpa")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconvwz")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectoroyw")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumnsl")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconfvc")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorunq")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumrim")}
                ></Text>
              </Flex>
            </Flex>
          </Flex>
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 321uml")}
        >
          <Divider
            width="385px"
            shrink="0"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 321lwo")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumhoy")}
                ></Text>
                <Text
                  fontFamily="Inter"
                  fontSize="14px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumzei")}
                ></Text>
              </Flex>
            </Flex>
            <View
