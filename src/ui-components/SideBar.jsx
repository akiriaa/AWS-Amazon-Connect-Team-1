    ...
    >
      ...
      >
        <Flex
          ...
          {...getOverrideProps(overrides, "Frame 321pfr")}
        >
          <View
            height="80px"
            shrink="0"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "ORGANIZATIONbbg")}
            ></Text>
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 321cog")}
            >
              <View
                width="24px"
                height="24px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconnkd")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectoripp")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                {...getOverrideProps(overrides, "Lorem Ipsumcyn")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              ...
              >
                <Icon
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectorfds")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 321qzd")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="ORGANIZATION"
              {...getOverrideProps(overrides, "ORGANIZATIONcyu")}
            ></Text>
            <Flex
              gap="16px"
              direction="column"
            ...
            >
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorsyz")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumpcg")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconuwa")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                ...
                <Text
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumpzf")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconrwg")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectornpk")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumhed")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconcop")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorjdh")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvos")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconqje")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorcgo")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvnd")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconldc")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorgjb")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumncf")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconcwg")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorekt")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumzai")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconyst")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorcfn")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumjur")}
                ></Text>
              </Flex>
            </Flex>
          </Flex>
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 321tsk")}
        >
          <Divider
            width="385px"
            shrink="0"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 321duh")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumpoy")}
                ></Text>
                <Text
                  fontFamily="Inter"
                  fontSize="14px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumazc")}
                ></Text>
              </Flex>
            </Flex>
            <View
