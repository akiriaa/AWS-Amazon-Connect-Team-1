    ...
    >
      ...
      >
        <Flex
          ...
          {...getOverrideProps(overrides, "Frame 321kbg")}
        >
          <View
            height="80px"
            shrink="0"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "ORGANIZATIONasc")}
            ></Text>
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 321fvj")}
            >
              <View
                width="24px"
                height="24px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconjar")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectormul")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                {...getOverrideProps(overrides, "Lorem Ipsumpoa")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              <View
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconaft")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectoreqcisw")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 321pkg")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="ORGANIZATION"
              {...getOverrideProps(overrides, "ORGANIZATIONujj")}
            ></Text>
            <Flex
              gap="16px"
              direction="column"
            ...
            >
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconxje")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorgyo")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumczv")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconwfs")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorzma")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvgi")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconvox")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectormng")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumxim")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconlut")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorlsl")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumhfz")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconddl")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorwcq")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumgtr")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconwbe")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorzsw")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumfsv")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconnky")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectoreqcopv")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumwyh")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconmyo")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectoribp")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumuqz")}
                ></Text>
              </Flex>
            </Flex>
          </Flex>
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 321rcp")}
        >
          <Divider
            width="385px"
            shrink="0"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 321kbi")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvth")}
                ></Text>
                <Text
                  fontFamily="Inter"
                  fontSize="14px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumfap")}
                ></Text>
              </Flex>
            </Flex>
            <View
