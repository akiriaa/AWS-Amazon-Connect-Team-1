  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagecta")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconbcj")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vectorfvc")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagesnf")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIconqwx")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="chat-bubble-outline"
            {...getOverrideProps(overrides, "MyIconswp")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="send"
            {...getOverrideProps(overrides, "MyIconnpp")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconouw")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vectorehz")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
